...
class CSS4 extends Component {
  render() {
    ...
    <h1 style={{ lineHeight: '100%', padding: '3%' }}>A</h1>
    </Accordion.Toggle>
    <Accordion.Collapse eventKey="0">
      <Card.Body><table class="w3-table-all notranslate" id="1">
  <tbody><tr>
...
<h1 style={{ lineHeight: '100%', padding: '3%' }}>B</h1>
    </Accordion.Toggle>
    <Accordion.Collapse eventKey="1">
      <Card.Body><table class="w3-table-all notranslate">
  <tbody><tr>
...
<Accordion.Toggle as={Card.Header} eventKey="2">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>C</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="3">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>D</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="4">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>E</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="5">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>F</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="6">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>G</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="7">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>H</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="8">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>I</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="9">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>J</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="10">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>K</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="11">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>L</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="12">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>M</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="13">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>O</h1>
    </Accordion.Toggle>
  ...
  <tr>
    <td><a href="pr_pos_overflow.asp">overflow</a><br></br>
    </td>
...
<Accordion.Toggle as={Card.Header} eventKey="14">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>P</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="15">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>Q</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="16">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>R</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="17">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>S</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="18">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>T</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="19">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>U</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="20">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>V</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="21">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>W</h1>
    </Accordion.Toggle>
...
<Accordion.Toggle as={Card.Header} eventKey="22">
     <h1 style={{ lineHeight: '100%', padding: '3%' }}>Z</h1>
    </Accordion.Toggle>
